-- Yes Hotel — PROPOSTA de persistência Gestão + CRM V1
-- NÃO faz parte de supabase/migrations/ — não aplicar automaticamente.
-- Sem DROP, sem ALTER destrutivo, sem trigger em operacional_*, sem backfill.
--
