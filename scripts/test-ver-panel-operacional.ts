...
// Sidebar operacional compacto (densidade ~70–75% em zoom 100%)
assert.match(cssSrc, /--op-sidebar-w:\s*176px/);
...
assert.match(panelSrc, /Inconsistência: mensagem enviada sem provisionamento da fechadura/);
assert.match(panelSrc, /Status da fechadura indisponível/);
...
ok("AÇÕES: Ver+⋯ always-on; PPD secondary; sidebar 176px; gate PPD intacto");
