-- =============================================================================
-- Yes Hotel — primeiro acesso ao apartamento + tolerância de 1h
-- Migration LOCAL: NÃO aplicar automaticamente nesta etapa (PR2).
-- Tabelas novas no modelo operacional (não reutiliza acessos_eventos legado).
-- =============================================================================

begin;

-- ---------------------------------------------------------------------------
-- Helper: leitura operacional (admin/recepção ativos)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- A. Eventos crus de acesso (sanitizados; sem senha)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- B. Estado da tolerância (1x por credencial)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- C. Resultado por item (3 acessos)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- D. RLS — leitura admin/recepção; escrita só service_role (Edge)
-- ---------------------------------------------------------------------------
...
-- escrita apenas via service_role (bypassa RLS) nas Edge Functions.
